...
stores = pd.DataFrame(client.query(f"SELECT store_id FROM {CH_DB}.stores where store_id = 101").result_rows, columns=["store_id"])
...
order_counter  = round(get_next_order_id() * 10)
# --- Order Generator ---
